...
//引入合约数据
var data = require("/Users/junjin/go/src/github.com/centrehq/centre-tokens/build/contracts/FiatTokenV2.json");
...
Storage.at(addressProxy).then( function(instance) {
    ...
    return proxyInstance.mint("0x840de23b190bdc5a93352d7f0086f039a7e9e760","1000000000000000000",{from:"0x840de23b190bdc5a93352d7f0086f039a7e9e760"});
    // return proxyInstance.totalSupply.call();
}).then(result=>{
...
// Storage.at(addressProxy).then( function(instance) {
//     proxyInstance = instance;
//     return proxyInstance.balanceOf("0x6cba6f3993f1f36a61806cb20c88d0ae13353ef6");
// }).then(result=>{
//     console.info(`before transfer balance:`, result.toString());
//     return proxyInstance.transfer("0x6cba6f3993f1f36a61806cb20c88d0ae13353ef6","200000000000000000",{from:"0x840de23b190bdc5a93352d7f0086f039a7e9e760"});
//     // return proxyInstance.totalSupply.call();
// }).then(result=>{
//     console.info(`mint result`, result.toString());
//     return proxyInstance.balanceOf("0x6cba6f3993f1f36a61806cb20c88d0ae13353ef6");
// }).then(result=>{
//     console.info(`after transfer balance:`, result.toString());
// }).catch(err=>{
//     console.log(err.toString());
// });
